...
public class SkillDetailPanel : MonoBehaviour
{
    ...
    private void showDetail()
    {
        ...
        if (numberOfSkill > 0)
        {
            ...
            GameObject.Find("Skill_1").GetComponentsInChildren<Text>()[1].text = ThaiFontAdjuster.Adjust(gameSystem.NowCharecter.allSkill[0].DesCripTion);
        }
        if (numberOfSkill > 1)
        {
            GameObject.Find("Skill_2").GetComponentsInChildren<Text>()[0].text = gameSystem.NowCharecter.allSkill[1].SkillName;
            GameObject.Find("Skill_2").GetComponentsInChildren<Text>()[1].text = ThaiFontAdjuster.Adjust(gameSystem.NowCharecter.allSkill[1].DesCripTion);
        }
        if (numberOfSkill > 2)
        {
            GameObject.Find("Skill_3").GetComponentsInChildren<Text>()[0].text = gameSystem.NowCharecter.allSkill[2].SkillName;
            GameObject.Find("Skill_3").GetComponentsInChildren<Text>()[1].text = ThaiFontAdjuster.Adjust(gameSystem.NowCharecter.allSkill[2].DesCripTion);
        }
    }
}
